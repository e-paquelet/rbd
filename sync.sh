...
if [ $APP =  "Y" ]; 
	then
		...
		echo -e "\e[33m==          - Ce script doit être exécuté IMPERATIVEMENT en tant qu'utilisateur root";
		echo -e "\e[33m==          - Zimbra doit avoir été installée ";
		echo -e "\e[33m==          - L'authentification par Active Directory Externe doit avoir été configuré sur Zimbra.";
		echo -e "\e[33m==          - Assurez vous d'avoir créer les comptes d'administrations de Zimbra également dans l'Active Directory";
		echo -e "\e[33m==          - Ces comptes d'administrations doivent être dans une UO (Unité d'Organisation) différente des UO que vous souhaitez lier";
		...
		echo -e "\e[33m==          Les sous UO présentent dans cette UO distinctive sont prise en compte par le script par récurrence.";
    echo -e "\e[33m==          Exemple : Voici une arbre représentant l'arborescence de l'Active Directory : ";
    ...
    echo -e "\e[33m== 		- DOMAIN_NAME=<<votredomain.local>>";
